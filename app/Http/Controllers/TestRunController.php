...
class TestRunController extends Controller
{
    ...
    public function store(Request $request, Project $project): RedirectResponse
    {
        ...
        $run = DB::transaction(function () use ($project, $validated): TestRun {
            ...
            if ($run->include_all && $run->suite_id) {
                $query = TestCase::where('suite_id', $run->suite_id)->whereNull('deleted_at');
    ...
    {
        Gate::authorize('view', $testRun->project);
    ...
    {
        Gate::authorize('delete', $testRun->project);
    ...
    {
        Gate::authorize('manageRuns', $testRun->project);
    ...
    {
        Gate::authorize('submitResults', $testRun->project);
    ...
    public function bulkResults(Request $request, TestRun $testRun): RedirectResponse
    {
        ...
        $request->validate(['results' => ['required', 'string']]);
